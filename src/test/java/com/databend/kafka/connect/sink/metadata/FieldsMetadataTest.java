...
public class FieldsMetadataTest {
    ...
    public void metadataMayNotBeEmpty() {
        extract(
                DatabendSinkConfig.PrimaryKeyMode.NONE,
                Collections.<String>emptyList(),
                null,
                null
        );
    ...
    private static FieldsMetadata extract(DatabendSinkConfig.PrimaryKeyMode pkMode, List<String> pkFields, Schema keySchema, Schema valueSchema) {
        return extract(pkMode, pkFields, Collections.<String>emptySet(), keySchema, valueSchema);
    }

    private static FieldsMetadata extract(DatabendSinkConfig.PrimaryKeyMode pkMode, List<String> pkFields, Set<String> whitelist, Schema keySchema, Schema valueSchema) {
